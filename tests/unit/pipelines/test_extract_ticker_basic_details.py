...
# First party
from src.pipelines.ticker_basic_details.steps.extract_ticker_basic_details import TickerBasicDetailsExtractor
...
class TestExtractTickerDetails(unittest.TestCase):
    ...
    @patch("src.pipelines.ticker_basic_details.steps.extract_ticker_basic_details."
